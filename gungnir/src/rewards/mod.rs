...
use crate::schema::{rewards,claimed,token_whitelist,airdrop_whitelist, airdrop_parameter,whitelist,wladdresses,wlalloc,mint_projects,nft_table};
...
impl std::str::FromStr for Calculationmode {
    ...
    fn from_str(src: &str) -> Result<Self,Self::Err> {
        match src {
            ...
            _             => Err(RWDError::new(&format!("Calculationmode {} does not exist",src))),
        }
    }
}
...
#[derive(Queryable, Identifiable, PartialEq, Debug, Clone, serde::Serialize, serde::Deserialize)]
#[table_name="rewards"]
pub struct Rewards {
    pub id                  : i64,
