...
mod tests {
    ...
    async fn decode_valid_jwt_token_with_success() {
        let (mut parts, _) = Request::builder().header("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiJ9.eyJzdWIiOiI2IiwiZXhwIjozMTg4MTg1NTc2Mjd9.JLDpBWAnnuYNp2ENlVq_GmuNDhJwexvzXgRDRF_1GCturfFmoJqQ563bG2Q9P5Kr0_ecWZVW-DUf1t0e83xLIg").body(()).expect("failed to create request").into_parts();
