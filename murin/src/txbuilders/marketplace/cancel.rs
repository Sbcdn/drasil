...
pub async fn build_mp_cancel (gtxd : &super::TxData , mptxd : &super::MpTxData, sc_script: &String, sc_addr : &String) -> Result<htypes::BuildOutput, MurinError> {
    ...
    let (txbody_,mut txwitness_, aux_data_, _,vkey_counter) = 
            perform_cancel(&cutils::to_bignum(2000000), sc_script, sc_addr, gtxd, mptxd, true)?;
