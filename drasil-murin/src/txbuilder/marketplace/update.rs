...
> {
    ...
    let datumpair_new = supporting_functions::make_datum_mp(
    ...
    txwitness.set_plutus_data(&decoded_datum.5);
...
pub async fn build_mp_update(
    ...
    //Create Tx
    let (txbody_, mut txwitness_, aux_data_, _, vkey_counter) = perform_update(
