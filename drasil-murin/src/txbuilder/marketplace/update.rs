...
impl<'a> super::PerformTxb<AtMPUpdateParam<'a>> for AtMPUpdateBuilder {
    fn new(t: AtMPUpdateParam) -> Self {
        AtMPUpdateBuilder {
            contract: t.0.clone(),
    ...
    fn perform_txb(
        ...
        // Is copy of Cancel change to update functionallity.
        todo!();
