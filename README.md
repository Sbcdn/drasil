...
Drasil system and concept was created by Torben and Zak, but it also utilises several tools developed by the Cardano community, to whom we are grateful and hope to continue to repay with our own small contributions.  In order to actually run a fully integrated and working "Drasil System" requires more than the applications and libraries found in this repository, however, and we can support and advise on how to utilize this framework for particular applications and consult on what it is required to run it effectively.
